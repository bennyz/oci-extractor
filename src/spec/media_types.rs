...
impl Serialize for MediaType {
        ...
        where S: Serializer
    {
        serializer.serialize_str(match *self {
            ...
            MediaType::ImageLayerNondistributableTar => "application/vnd.oci.image.layer.nondistributable.v1.tar",
            MediaType::ImageLayerNondistributableTarGzip => "application/vnd.oci.image.layer.nondistributable.v1.tar+gzip",
            MediaType::ImageLayerNonDistributableZstd => "application/vnd.oci.image.layer.nondistributable.v1.tar+zstd"
        })
    }
}
...
impl<'de> Deserialize<'de> for MediaType {
        ...
        where D: Deserializer<'de>
    {
        ...
        Ok(match s.as_str() {
            ...
            "application/vnd.oci.image.layer.nondistributable.v1.tar" => MediaType::ImageLayerNondistributableTar,
            "application/vnd.oci.image.layer.nondistributable.v1.tar+gzip" => MediaType::ImageLayerNondistributableTarGzip,
            "application/vnd.oci.image.layer.nondistributable.v1.tar+zstd" => MediaType::ImageLayerNonDistributableZstd,
